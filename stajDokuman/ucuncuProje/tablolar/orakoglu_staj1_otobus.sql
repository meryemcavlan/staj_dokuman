...
CREATE TABLE `otobus` (
  ...
  `otobus_no` int NOT NULL,
  PRIMARY KEY (`otobus_id`),
  UNIQUE KEY `otobus_no_UNIQUE` (`otobus_no`)
...
INSERT INTO `otobus` VALUES (1,1),(2,2),(9,3),(10,4),(11,5),(21,7),(14,8),(15,9),(17,10),(22,12),(23,13),(28,26);
...
-- Dump completed on 2023-10-03 14:28:06
